...
import photosListStyle from "../../styles/PhotoList.module.css";
...
export const getStaticProps = async (context) => {
  // getSataticPaths 로 전송된 paths 배열을 활용하는 경우에는
  // constext.params 를 활용한다.
